  ...
  function gfResource($http, Conf) {
    return function (collectionName) {
      ...
      Resource.query = function (params) {
        return $http.get(collectionUrl, { params: angular.extend({ q: JSON.stringify({} || params) }) }).then(function (response) {
          var result = [];
      ...
      Resource.save = function (data) {
        return $http.post(collectionUrl, data).then(function (response) {
      ...
      Resource.remove = function (data) {
        return $http.delete(collectionUrl).then(function (response) {
          return new Resource(data);
        });
      };
