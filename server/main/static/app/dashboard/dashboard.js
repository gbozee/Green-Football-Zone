(function () {
    ...
    angular.module('app').controller(controllerId, ['$rootScope', 'common','gfService', 'datacontext',
        'userInfo','Conf','Pusher','$scope', dashboard]);
//    angular.module('app').controller('userReplies', ['$location', 'common', 'datacontext', userRepliesCtrl]);
    angular.module('app').controller('userTopics', ['$filter','userInfo','$scope', userTopicsCtrl]);
    angular.module('app').controller('followedTeams', ['userInfo', followedTeamsCtrl]);
    ...
    function dashboard($rootScope, common, gfService,datacontext, userInfo,Conf,Pusher,$scope) {
        ...
        function getAdminTeams() {
            return myTeamResource.getList({team_admin: true}).
                then(function (data) {
                    vm.adminTeams = data;
                });
        }
