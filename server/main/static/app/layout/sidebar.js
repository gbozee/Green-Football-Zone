(function () {
    ...
    angular.module('app').controller(controllerId,
        ['$location', '$route','common', 'config', 'routes', 'userInfo', sidebar]);
    ...
    function sidebar($location,common, $route, config, routes, userInfo) {
        ...
        vm.search = search;
        vm.searchText = '';
//        vm.isAdmin = datacontext.isAdmin();
//        vm.isAuthor = datacontext.isAuthor();
...
//        function getDetails(forceRersh){
//            return datacontext.getUserInfo(forceRersh).then(function(data){
//                vm.user = data;
