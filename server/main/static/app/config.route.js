(function () {
        ...
        return [
            ...
            },
            {
                ...
                config: {
                    ...
                    resolve: {
                        update_topic: set_update_league
    ...
    single_topic.$inject = ['common', '$route', 'datacontext'];
    function single_topic(common, $route, datacontext) {
        var defer = common.$q.defer()
        datacontext.getTopicById($route.current.pathParams.topic_id)
            .then(function (data) {
                defer.resolve(data)
            });
    ...
    set_team.$inject = ['ReplyService','$route'];
    function set_team(replyService,$route){
        return replyService.getTopic($route.current.pathParams.topic_id)
            .then(function(data){
